...
public class VincentyGeodesy {
    ...
    /**
     * returns the {@link STPoint} that is in the given direction at the
     ...
     */
    public static STPoint moveInDirection(STPoint point, double bearingInDegrees, double distanceInMeters) {
        ...
        return new STPoint(newLon, newLat);
    }

    public static double distanceInMeters(STPoint foo, STPoint bar) {
        double a = 6378137, b = 6356752.3142, f = 1 / 298.257223563; // WGS-84
        // ellipsiod
